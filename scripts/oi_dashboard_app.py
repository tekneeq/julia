...
Auto-refreshes every 15s so live price ticks (from `price_poller.py`)
...
with st.sidebar:
    ...
    auto = st.toggle("Auto-refresh every 15s", value=True, key="auto")
    if auto:
        st_autorefresh(interval=15_000, key="_autoref")
